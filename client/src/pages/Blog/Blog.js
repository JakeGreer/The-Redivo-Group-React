                ...
                <div className='container top-container'>
                    <div className='row'>
                        ...
                        <Dropdown
                            ...
                            items={[
                                {name:'1',onClick: ()=>{this.setLimit(1)}},
                                {name:'3',onClick: ()=>{this.setLimit(3)}},
                                {name:'5',onClick: ()=>{this.setLimit(5)}},
                                {name:'10',onClick: ()=>{this.setLimit(10)}},
                            ]}
                            />
                        </div>
                    </div>
                        ...
                        <div className='container'>
                            <div className='blog-post-container'>
                                {this.state.docs.map(function(post,i){
                                    return(
                                    <div className='blog-holder' rel={post._id} key={i+post._id} id={`blog-post-${post._id}`}>
                ...
                <div className='blog-box'>
                    <div className='container'>
                        ...
                        <div class="text-center">
                            <p id='pageNums'>Page {this.state.page} of {this.state.pages}</p>
                        </div>
                    </div>
                </div>
        </div>
